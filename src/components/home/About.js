  ...
  return (
    <section className='section'>
      ...
      <ul class="about_text">
        ...
        <li>
        In high school, I was really into sports. I was the captain of my water polo team, and helped my team to
        ...
        balancing my love for sports with my tech interests. Soon after highschool I started working 
        at a bike shop where I contined my passion for solving technical problems.
        </li>
        <li>
        My journey into computer science however, began at the College of the Sequoias.Like many, the 
        ...
        <li>
        While at Fresno State, I didn't just stick to the classroom. I worked as a classroom aid at
